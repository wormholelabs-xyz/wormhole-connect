...
export const TESTNET_TOKENS: TokensConfig = {
  ...
  WETHsepolia: {
    ...
    tokenId: {
      chain: 'Sepolia',
      address: '0x7b79995e5f793A07Bc00c21412e50Ecae098E7f9', // TODO: different than what's set on Token Bridge?
    },
    coinGeckoId: 'ethereum',
    color: '#5794EC',
    decimals: 18,
  ...
  WMON: {
    ...
    tokenId: {
      chain: 'MonadDevnet',
      address: '0xDC6d98E395eA2Ee588427d23ddDFcA8e324D0344', // TODO: not sure if right
    },
    coinGeckoId: 'monad',
    decimals: 18,
  },
  WETHmonad: {
    ...
    tokenId: {
      chain: 'MonadDevnet',
      address: '0x64667D1e6d22e9B1E91412c8467E31AFD263b319', // Sepolia origin WETH
    },
    coinGeckoId: 'Ethereum',
    decimals: 18,
  },
  USDCmonad: {
    ...
    tokenId: {
      chain: 'MonadDevnet',
      address: '0x964b27e3De53721307a06BD873bbebAab33b8f10',
    },
    coinGeckoId: 'usd-coin',
    decimals: 6,
  },
  WBTCmonad: {
    ...
    tokenId: {
      chain: 'MonadDevnet',
      address: '0x3cbB549588A1D938e9036FE9d65ca67c01697751',
    },
    coinGeckoId: 'wrapped-bitcoin',
    decimals: 8,
  },
  UNImonad: {
    ...
    tokenId: {
      chain: 'MonadDevnet',
      address: '0xeBd96B1aeAB3C04762b3Db17fC3D9ed480c77b4A',
    },
    coinGeckoId: 'uniswap',
    decimals: 18,
  },
