import { ChainContext, isSameToken, Network, routes, TokenId, Wormhole } from "@wormhole-foundation/sdk";
import { MultiTokenNttAutomaticRoute, MultiTokenNttRoute } from "@wormhole-foundation/sdk-route-ntt";
